...
public class AdminController {
	...
	public void memberManageGET(Criteria cri, Model model) throws Exception{
		...
		logger.info("멤버 관리 페이지 접속.........." + cri);

		/* 작가 목록 출력 데이터 */
		List list = adminService.memberGetList(cri);

		if(!list.isEmpty()) {
			model.addAttribute("list",list);	// 맴버 존재 경우
		} else {
			model.addAttribute("listCheck", "empty");	// 멤버 존재하지 않을 경우
		}
	...
	public void memberDeletePOST(@RequestParam("memberId") String memberId) throws Exception {
