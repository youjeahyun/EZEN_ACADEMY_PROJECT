...
<body>
	<nav role="navigation">
	  <div id="menuToggle">
	    ...
	    <ul id="menu">
	        <a href="category_picture.jsp"><li>지친 나를 다독여주는 "글귀"</li></a>
	...
	<h1> 직접보고 느끼는 것 같은 "사진" </h1>
	<h2> It's a gift for you. Look and feel! <br> 너를 위한 선물이야. 힐링을 느껴봐!</h2>
		<!-- 데이터베이스로 이미지추가 -->
		<%
			...
			for(int i=0; i<test.size();i++){
				int j = i;
				Img tt = test.get(i);
				if(tt.getImgpicture()!=null){
				System.out.println(tt.getImgnum());
				
				
		%>
			<img src="${pageContext.request.contextPath}\<%=tt.getImgpicture()%>" id="<%=j%>" alt="오류발생! 클릭하여 삭제 후 재진행 필요합니다.">
