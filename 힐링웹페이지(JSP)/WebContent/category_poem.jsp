...
<%
	...
	for(int i=0; i<test.size();i++){
		int j = i;
		Img tt = test.get(i);
		if(tt.getImgpoem()!=null){
		System.out.println(tt.getImgnum());
		
		
%>
	<img src="${pageContext.request.contextPath}\<%=tt.getImgpoem()%>" id="<%=j%>" alt="오류발생! 클릭하여 삭제 후 재진행 필요합니다.">
